...
class getToken:
	...
	def DESKTOPMAC(self):
	    ...
	    'X-Line-Application': "DESKTOPMAC\t5.10.0\thonku1990\tTools\t10.13.2",
	    "x-lal": "ja-US_US",
	    }
	    return Headers
	...
	def DESKTOPWIN(self):
	    Headers = {
	    'User-Agent': "Line/8.3.2",
	    'X-Line-Application': "DESKTOPWIN\t5.10.0\thonku1990\tTools\t10.13.2",
	    "x-lal": "ja-US_US",
	    }
	    return Headers
	...
	def IOSIPAD(self):
	    Headers = {
	    'User-Agent': "Line/8.3.2",
	    'X-Line-Application': "IOSIPAD\t8.14.2\thonku1990\tTools\t11.2.5",
	    "x-lal": "ja-US_US",
	    }
	    return Headers
	...
	def CHROMEOS(self):
	    Headers = {
	    'User-Agent': "Line/8.3.2",
	    'X-Line-Application': "CHROMEOS\t2.1.5\thonku1990\tTools\t11.2.5",
	    "x-lal": "ja-US_US",
	    }
	    return Headers
	...
	def WIN10(self):
	    Headers = {
	    'User-Agent': "Line/8.3.2",
	    'X-Line-Application': "WIN10\t5.5.5\thonku1990\tTools\t11.2.5",
	    "x-lal": "ja-US_US",
	    }
	    return Headers
