...
botStart = time.time()
#cl = LINE("EOd7e0ri3S4m6fbhIG99.FPtG83UKfRHDFdQCJEiH/q.w0lj1rLtx5IeBLhZf2uSPWXf5Na4yv9n1kFLopVu8PA=")
#cl = LINE("YOUR TOKEN")
cl = LINE("honx9617@gmail.com","honx90")
...
Headers1 = {
        ...
        'X-Line-Application': "CROMEOS\t2.1.5honku1990\t11.2.5",
        "x-lal": "ja-US_US",
    }
connect2 = 'WIN'
Headers2 = {
        'User-Agent': "Line/9.22.1",
        'X-Line-Application': "DESKTOPWIN\t5.5.5honku1990\t11.2.5",
        "x-lal": "ja-US_US",
    }
connect3 = 'ios'
Headers3 = {
...
settings = {
    ...
    "commentPost": "LIKE U",
    "detectMention": True,
    "autoResponMessage": "Tar Ngtag Panci",
    "responsticker": False,
    "changeGroupPicture":[],
    "notifikasi": False,
    "Sider":{},
    ...
    data = {
            ...
            "contents": {
             ...
             "hero": {
               ...
               "action": {
                 "type": "uri",
                 "uri": "https://line.me/ti/p/~honku1990"
                 }
               },
                   "type": "bubble",
                   "body": {
...
def sendTextTemplateMaster(to, text):
  ...
  "styles": {
    ...
    "header": {
     ...
     "aspectRatio": "2:1",
     "aspectMode": "cover",
     "url": "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSkoV9mrOZytMrPcwNNHnh5bZXgHsr-HCYv9sTy_8vbr_u209Ym",
     "size": "full",
     "margin": "xl"
  },
  "footer": {
      ...
      "contents": [{
          ...
          "contents": [{
              ...
              "action": {
                  "type": "uri",
                  "label": "TKS",
                  "uri": "http://line.me/ti/p/~honku1990"
              }
          }, {
              "flex": 3,
              "type": "button",
...
def clBot(op):
  ...
  "contents": [
    {
      ...
      "body": {
        "contents": [
          ...
          {
            "type": "image",
        "url": "https://1.bp.blogspot.com/-kWaPifA5NAA/XavsPHi-SVI/AAAAAAAAOiw/HtqcQ_mkRVAPTh3r9Pq1LbX9iNfA61hXACEwYBhgL/s1600/gambar%2Btengkorak%2Bkeren%2B57.jpg", #hp
        "aspectRatio": "2:1",
        "aspectMode": "cover",
        "size": "full",
          },
    ...
    },
    {
      ...
      "body": {
        "contents": [
          ...
          {
            "type": "image",
        "url": "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRk9_EsNkVD-ZuyKhPqWuuTonfQQV67n1HQPEvBGP99-_IvJXJO", #hp
        "aspectRatio": "2:1",
        "aspectMode": "cover",
        "size": "full",
          },
    ...
    },
    {
      ...
      "body": {
        "contents": [
          ...
          {
            "type": "image",
        "url": "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcR04qjEfM4-SjpjQIp0d4odK7_AKB4ub7_4E_7u1vdU8WUVKc6t", #hp
        "aspectRatio": "2:1",
        "aspectMode": "cover",
        "size": "full",
          },
    ...
    },
    {
      ...
      "body": {
        "contents": [
          ...
          {
            "type": "image",
        "url": "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQz92vSGom4gzN8DXczea2_WcV9WIqg1S9dlKxla-ioFX3fqHAQ", #hp
        "aspectRatio": "2:1",
        "aspectMode": "cover",
        "size": "full",
          },
    ...
    },
    {
      ...
      "body": {
        "contents": [
          ...
          {
            "type": "image",
        "url": "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTxSkQ3RugwH_XEXnN2BiLfYx6eWEcCUFrI64v4L8HQXJ0Pni4U", #hp
        "aspectRatio": "2:1",
        "aspectMode": "cover",
        "size": "full",
          },
    ...
    },
    {
      ...
      "body": {
        "contents": [
          ...
          {
            "type": "image",
        "url": "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRGp-3Z6lORy_v46nsJWPrcS6nTD3u6FSkjnRf5rs9BNg3x3vXZ", #hp
        "aspectRatio": "2:1",
        "aspectMode": "cover",
        "size": "full",
          },
  ...
  "type": "carousel"
                    ...
                    try:
                        arr = []
                        owner = "u7d1299988c9ae3940845f36734d4a302"
                        ...
                        ret_ += "\n╠ Version : Free v 1.1 by Tks_bot"
                        ret_ += "\n╠ Creator : {}".format(creator.displayName)
                        ret_ += "\n╚ Git : https://github.com/Panci/TKS"
                  ...
                  "uri": search_url
                    ...
                    if msg.toType == 2:
                             ...
                             for x in range(jmlh):
                                 ...
                                 sendTextTemplate(msg.to, "The bot has been mmade with TENGKULAK")
                                    ...
                                    for music in a["items"]:
                                        ret_.append({
                                            ...
                                            "hero": {
                                                ...
                                                "action": {
                                                    "type": "uri",
                                                    "uri": "line://nv/profilePopup/mid=u7e94e0f37ba416b85d7c3a9c8de221f9"
                                                }
                                            },
                                            "body": {
                                                "type": "box",
